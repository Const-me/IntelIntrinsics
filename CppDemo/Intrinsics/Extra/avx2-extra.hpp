...
namespace Intrinsics
{
	namespace Avx
	{
		...
		{
			const __m256i zero = setzero_all();
		...
		inline bool XM_CALLCONV cmplt_all( __m256i a, __m256i b )
		{
			...
			const __m256i signBits = set1_epu8( 0x80 );
		...
		// true if a > b, for unsigned integers occupying the whole registers
		inline bool XM_CALLCONV cmpgt_all( __m256i a, __m256i b )
		{
